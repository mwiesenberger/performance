...
#SBATCH -J benchmark
#SBATCH -N 2 -n 8 --ntasks-per-node=4 -A fuac4_feltor --exclusive --gres=gpu:4 -p m100_fua_prod
#SBATCH --time=12:00:00

###please specify a info file (for humans)
#SBATCH -o "benchmark_v100nv_mpi8.info"
FILENAME='benchmark_v100nv_mpi8' # name of output file
...
mpirun -gpu -n 8 ./ping_mpit

COMMAND='mpirun -gpu -n 8 ./cluster_mpib'
FILE=""$FILENAME".csv"
