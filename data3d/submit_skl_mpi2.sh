...
#SBATCH -J benchmark
#SBATCH -N 2 -n 4 --ntasks-per-socket=1 -c 24 --hint=memory_bound
...
#SBATCH -o "benchmark_skl_mpi2.info"
FILENAME='benchmark_skl_mpi2' # name of output file
    ...
    for o in 3 4; do
        for N in 36 72 144 288; do
            for Nz in 16 32 64 128; do
                echo "1 4 1 $o $N $N $Nz" | $COMMAND ./cluster_mpib >> $FILE
            done
        done
    done
done
