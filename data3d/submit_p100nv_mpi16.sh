...
#SBATCH -J benchmark
#SBATCH -N 4 -n 16 --ntasks-per-node=4 -A fusio_ru3DTU_1 --gres=gpu:4 -p dvd_fua_prod
#SBATCH --time=12:00:00

###please specify a info file (for humans)
#SBATCH -o "benchmark_p100nv_mpi16.info"
FILENAME='benchmark_p100nv_mpi16' # name of output file
...
mpirun -n 16 ./ping_mpit

COMMAND='mpirun -n 16 ./cluster_mpib'
FILE=""$FILENAME".csv"
