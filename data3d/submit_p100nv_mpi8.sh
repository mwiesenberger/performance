...
#SBATCH -J benchmark
#SBATCH -N 2 -n 8 --ntasks-per-node=4 -A fusio_ru3DTU_1 --gres=gpu:4 -p dvd_fua_prod
#SBATCH --time=12:00:00

###please specify a info file (for humans)
#SBATCH -o "benchmark_p100nv_mpi8.info"
FILENAME='benchmark_p100nv_mpi8' # name of output file
